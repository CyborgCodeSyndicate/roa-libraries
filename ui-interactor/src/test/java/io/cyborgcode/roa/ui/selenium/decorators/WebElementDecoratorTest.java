...
class WebElementDecoratorTest {
    ...
    @Test
    @DisplayName("getDomAttribute() should delegate to original WebElement and return the requested attribute value")
    void shouldDelegateGetAttributeMethod() {
        // Given
        String attributeName = "id";
        String expectedValue = "element-id";
        when(mockWebElement.getDomAttribute(attributeName)).thenReturn(expectedValue);

        // When
        String result = decorator.getDomAttribute(attributeName);

        // Then
        assertEquals(expectedValue, result);
        verify(mockWebElement).getDomAttribute(attributeName);
    }
    ...
    @Test
    @DisplayName("getDomAttribute() should handle null return value")
    void shouldHandleNullAttribute() {
        when(mockWebElement.getDomAttribute("missing")).thenReturn(null);
        assertNull(decorator.getDomAttribute("missing"));
    }
}