...
public abstract class AbstractComponentService<T extends ComponentType, C> {
   ...
   /**
    * Constructs a new AbstractComponentService with the given Page.
    *
    * @param Page The Page instance for UI interactions.
    */
   protected AbstractComponentService(final Page page) {
      this.page = page;
   }
