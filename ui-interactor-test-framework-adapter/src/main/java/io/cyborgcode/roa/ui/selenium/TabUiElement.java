 ...
 */
@Pandora(
      description = "Tab UI element enum contract (locator + component type + hooks) consumed by TabService "
            + "for standardized tab interactions.",
      tags = {"ui", "ui-element", "tab"},
      creation = CreationKind.ENUM_CONSTANT
)
@PandoraOptions(
      availableOptionsRule = AvailableOptionsUiRules.AvailableTabUiElements.class,
