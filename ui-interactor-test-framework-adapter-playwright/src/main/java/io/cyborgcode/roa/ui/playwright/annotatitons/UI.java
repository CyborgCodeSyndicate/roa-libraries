package io.cyborgcode.roa.ui.playwright.annotatitons;

import io.cyborgcode.roa.framework.annotation.FrameworkAdapter;
import io.cyborgcode.roa.ui.playwright.extensions.UiTestExtension;
...
@FrameworkAdapter(basePackages = {"io.cyborgcode.roa.ui"})
