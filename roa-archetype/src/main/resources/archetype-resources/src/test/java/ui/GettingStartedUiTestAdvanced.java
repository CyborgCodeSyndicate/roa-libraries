...
import ${package}.ui_module.ui.authentication.ExampleCredentials;
import ${package}.ui_module.ui.authentication.ExampleAppUiLogin;
 ...
 *
 * <p>Includes examples for raw values, crafted data, auth, preconditions, and a custom ring.
...
public class GettingStartedUiTestAdvanced extends BaseQuest {
   ...
   void createExampleUsingAuthentication(Quest quest,
                                         @Craft(model = DataCreator.Data.EXAMPLE_TABLE_MODEL) ExampleTableModel model) {
