...
public abstract class TableAssertionFunctionsServiceCore<E extends BaseUiElement> {
    ...
    */
   public boolean validateTableNotEmpty(Object actual, Object expected) {
    ...
    */
   public boolean validateTableRowCount(Object actual, Object expected) {
    ...
    */
   public boolean validateEveryRowContainsValues(Object actual, Object expected) {
    ...
    */
   public boolean validateTableDoesNotContainRow(Object actual, Object expected) {
      if (!(actual instanceof List<?> && expected instanceof List<?>)) {
         return false;
      }
    ...
    */
   public boolean validateAllRowsAreUnique(Object actual, Object expected) {
      if (!(actual instanceof List<?>)) {
         return false;
      }
      List<?> table = (List<?>) actual;
    ...
    */
   public boolean validateNoEmptyCells(Object actual, Object expected) {
    ...
    */
   public boolean validateColumnValuesAreUnique(Object actual, Object expected) {
      if (!(actual instanceof List<?>) || !(expected instanceof Integer)) {
         return false;
      }
    ...
    */
   public boolean validateTableDataMatchesExpected(Object actual, Object expected) {
      if (!(actual instanceof List<?>) || !(expected instanceof List<?>)) {
         return false;
      }
    ...
    */
   public boolean validateRowNotEmpty(Object actual, Object expected) {
      if (!(actual instanceof List<?>)) {
         return false;
      }
    ...
    */
   public boolean validateRowContainsValues(Object actual, Object expected) {
      if (!(actual instanceof List<?>) || !(expected instanceof List<?>)) {
         return false;
      }
    ...
    */
   public boolean validateAllCellsEnabled(Object actual, Object expected) {
      if (!(actual instanceof List<?>)) {
         return false;
      }
      List<?> table = (List<?>) actual;
    ...
    * {@code false}.
    */
   public boolean validateAllCellsClickable(Object actual, Object expected) {
      if (!(actual instanceof List<?>)) {
         return false;
      }
      List<?> table = (List<?>) actual;
