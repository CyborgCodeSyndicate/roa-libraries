 ...
 */
public interface TableElementCore<K extends Enum<K>, D> {
    ...
    *
    * @return A {@link Consumer} accepting {@link D} for executing preconditions.
    */
    ...
    *
    * @return A {@link Consumer} accepting {@link D} for executing postconditions.
    */
