package io.cyborgcode.roa.ui.service;
 ...
 * a {@link D} instance for interacting with web elements.
 *
 * @author Cyborg Code Syndicate 💍👨💻
 */
public abstract class InsertionServiceElementImplCore<D, L> extends BaseInsertionService<InsertionElement, L> {
    ...
    */
   public InsertionServiceElementImplCore(final InsertionServiceRegistry<L> serviceRegistry,
                                          final D webDriver) {
   ...
   protected Class<? extends ComponentType> getComponentTypeEnumClass(final InsertionElement annotation) {
      final UiElementCore<L, D> uiElement = (UiElementCore<L, D>) Enum.valueOf(
   ...
   /**
    * Builds a Selenium {@link L} locator for the UI element specified by the annotation.
    *
    * @param annotation The annotation instance attached to the field.
    * @return A Selenium locator targeting the element.
    */
   @Override
   protected L buildLocator(final InsertionElement annotation) {
      final UiElementCore<L, D> uiElement = (UiElementCore<L, D>) Enum.valueOf(
            (Class<? extends Enum>) annotation.locatorClass(),
            annotation.elementEnum()
      );
   ...
   /**
    * Executes any pre-insertion action defined by the {@link UiElementCore#before()} consumer.
    *
    * @param annotation The annotation instance attached to the field.
    */
   @Override
   ...
   /**
    * Executes any post-insertion action defined by the {@link UiElementCore#after()} consumer.
    *
    * @param annotation The annotation instance attached to the field.
    */
   @Override
